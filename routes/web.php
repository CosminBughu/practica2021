...
Route::match(['get', 'post'], '/login', [AuthController::class, 'login'])->name('login'); //login controller
Route::match(['get', 'post'], '/register', [AuthController::class, 'register'])->name('register'); //register controller
Route::get('/verify-email', [AuthController::class, 'verifyNotice'])->middleware('auth')->name('verification.notice');  //verify email controller
...
Route::middleware(['verified'])->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::match(['post'], '/users/{id}', [AdminController::class, 'update'])->name('users.update');
